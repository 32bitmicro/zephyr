...
/**
 * @file SoC configuration macros for the ST STM32F2xx family processors.
 *
 * Refer to the ST DocID 15403 Rev 7 datasheet for more information about
 * these registers.
 */

#ifndef _ST_STM32F2XX_SOC_REGS_H_
#define _ST_STM32F2XX_SOC_REGS_H_
