...
/**
 * @file SoC configuration macros for the ST STM32F2 family processors.
 */

#ifndef _ST_STM32_SOC_H_
#define _ST_STM32_SOC_H_
...
#define RCC_CFGR_MCO_2_HSE	0xC0000000
...
/* IRQ numbers pulled from Table 20 (Section 8.1.3) of ST DocID 15403 Rev 7 */
 ...
 *
 * TODO - These should be moved to the appropriate drivers as they get added,
 * they are simply kept here for future knowledge instead of having to go search
 * for them again.
 */
